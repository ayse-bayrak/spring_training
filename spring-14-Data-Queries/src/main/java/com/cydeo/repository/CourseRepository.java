...
//JPA Repository doesn't give it to me.. means if we go to JpaRepostory there is not method related needed business
    ...
    //do we need to from courses No, because Spring JPA already knos wwhich table we are working with
    //How? because we are inside the this Repository meeaning relatin table (here Course)
