...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        paymentRepository.delete(payment1); // because of cascading ==> cascade.All==> whenever you do anything on the parents
        //save, delete also do same action inside the child as well. That's why when i delete the parent child is going to delete
